...
namespace IterationStatements
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var num = 0;//Create a variable of type int and name it num
            ...
            do // Create a do-while loop and use the template below:
            {
                ...
                {
                    numbers.Add(num);   // Hint: reference num inside of the Add method's parentheses
                }                       // numbers.Add(/* num */);
            ...
            foreach (var counting in numbers)// Create a foreach loop using the collection - numbers
            {
                Console.WriteLine(counting); //In the scope of the foreach loop, print each number in numbers
            }
